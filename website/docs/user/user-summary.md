...
description: Requests to this endpoint will retrieve a summary of a users PlayStation Stars record
---
...
| id | String | `empty-slot-0` | GUID for the displayed collectible<br/>`empty-slot-x` if the user has not set a collectible in this display position
...
| displayTotalPointsBalance | Numeric | `0` | Total reward points balance (formatted?)
